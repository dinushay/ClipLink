    ...
    for entry in all_streamers:
        ...
        if clip is None and entry.get("last_clip_id") is None:
            ...
            if clip_id != entry.get("last_clip_id"):
                ...
                view.add_item(nextcord.ui.Button(label="Watch Clip", style=nextcord.ButtonStyle.link, url=clip['url'], emoji="▶️"))
                ...
                if clip.get("video_id") and clip.get("vod_offset") is not None:
                    ...
                    view.add_item(nextcord.ui.Button(label="Jump to VOD", style=nextcord.ButtonStyle.link, url=vod_url, emoji="⏱️"))
